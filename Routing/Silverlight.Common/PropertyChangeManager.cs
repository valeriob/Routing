...
namespace Silverlight.Common
{
        ...
        where TSource : INotifyPropertyChanged
    {
        ...
        public void RemoveHandler(PropertyChangedEventHandler handler)
        {
            ...
            var toBeRemoved = subscriptions.Where(s => s.SubscriberReference.Target == handler.Target && s.MethodCallback == handler.Method);
        ...
        private void CleanupSubscribers()
        {
            ...
            var toBeRemoved = subscriptions.Where(s => !s.IsStatic && !s.SubscriberReference.IsAlive);
            foreach (var subscription in toBeRemoved)
                subscriptions.Remove(subscription);
        }
