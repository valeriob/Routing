...
{
    public class Search_Destination_Helper : Use_Case_Manager<DestinationDto>
    {
        public DestinationSearchViewModel ViewModel { get; protected set;}
        public Search_Destination_Helper()
        {
            ViewModel = new DestinationSearchViewModel();
        }
